...
router.post('/registration', async (req, res) => {
    ...
    const sendEmail = {
      ...
      html: `<h2>Your requested for activation <a href='http://localhost:9000/users/activation/${token}'>http://localhost:9000/users/activation/${token}</a> click this link to active your account</h2>`
    };
...
router.post('/forget-password', async (req, res) => {
  ...
  const sendEmail = {
    ...
    html: `<h2>The link for reset your password will expire in 1 hour.<a href='http://localhost:9000/users/reset-password/${resetToken}'>http://localhost:9000/users/reset-password/${resetToken}</a></h2>`
  };
